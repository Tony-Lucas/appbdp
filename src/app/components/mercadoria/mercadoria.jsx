...
export default class Component extends React.Component {
    ...
    async componentDidMount() {
        const result = await fetch('https://bdpapiserver.com/mercadoria/limite/' + this.state.limite + "/" + this.state.pulos + "/" + sessionStorage.getItem('token'));
    ...
    async changeStatusToTwo(e) {
        const result = await fetch('https://bdpapiserver.com/mercadoria/' + e.target.getAttribute('idmercadoria') + '/' + sessionStorage.getItem('token'));
    ...
    async deletaMercadoria(e) {
        ...
        const result = await fetch('https://bdpapiserver.com/mercadoria/' + id, {
            method: "delete",
            headers: {
    ...
    async alteraMercadoria(e) {
        const id = e.target.getAttribute('idmercadoria');
        const result = await fetch('https://bdpapiserver.com/mercadoria/' + id + '/' + sessionStorage.getItem('token'));
        const mercadoria = await result.json();
